...
def main(args):
    ...
    if args.do_predict and os.path.exists(args.result_file):
        ...
        for topn in range(selected_topn):
            ...
            elif args.data_name == "USPTO_480kseed42":
                filename = "USPTO_480kseed42_g2s_series_rel_smiles_smiles.1.result_token.txt"
            elif args.data_name == "USPTO_480kseed2025":
                filename = "USPTO_480kseed2025_g2s_series_rel_smiles_smiles.1.result_token.txt"
            else:
                filename = "USPTO_480k_g2s_series_rel_smiles_smiles.1.result_token.txt"
            ...
            for seed in selected_dropouts:
                if args.data_name == 'USPTO480k_rare':
                    ...
                    filename = 'USPTO_480kseed42_g2s_series_rel_smiles_smiles.1_drop{}_result_idx_token.txt'.format(seed)
                elif args.data_name == "USPTO_480kseed2025":
                    filename = 'USPTO_480kseed2025_g2s_series_rel_smiles_smiles.1_drop{}_result_idx_token.txt'.format(seed)
                else:
                    filename = 'USPTO_480k_g2s_series_rel_smiles_smiles.1_drop{}_result_idx_token.txt'.format(seed)
                with open(f"./results/{filename}", "r") as f_predict:
                    file_candiates = []
                    for i, line_predict in enumerate(f_predict):
                        split_data = line_predict.split(",")
        ...
        selected_dropouts = [42, 101, 202, 303, 2025]
        selected_dropouts = [42, 101]
        ...
        for topn in range(selected_topn):
            for modeli in select_models:
                if args.data_name == 'USPTO480k_rare':
                    ...
                    filename = 'USPTO_480kseed42_g2s_series_rel_smiles_smiles_{}_1_result_idx_token.txt'.format(modeli)
                elif args.data_name == "USPTO_480kseed2025":
                    filename = 'USPTO_480kseed2025_g2s_series_rel_smiles_smiles_{}_1_result_idx_token.txt'.format(modeli)
                else:
                    filename = 'USPTO_480k_g2s_series_rel_smiles_smiles_{}_result_idx_token.txt'.format(modeli)
                ...
                for seed in selected_dropouts:
                    try:
                        if args.data_name == 'USPTO480k_rare':
                            ...
                            filename = 'USPTO_480kseed42_g2s_series_rel_smiles_smiles_{}_1_drop{}_result_idx_token.txt'.format(modeli, seed)
                        elif args.data_name == "USPTO_480kseed2025":
                            filename = 'USPTO_480kseed2025_g2s_series_rel_smiles_smiles_{}_1_drop{}_result_idx_token.txt'.format(modeli, seed)
                        else:
                            filename = 'USPTO_480k_g2s_series_rel_smiles_smiles_{}_drop{}_result_idx_token.txt'.format(modeli, seed)
                        with open(f"./results/{filename}", "r") as f_predict:
                            file_candiates = []
