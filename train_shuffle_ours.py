...
def main(args):
    ...
    for epoch in range(args.epoch):
        ...
        if epoch >= 5 and boosting_save >= args.boosting_interval:
            ...
            torch.save(state, f"save_shuffle{args.select_train_data_ratio}/model.{epoch}.pt")
        ...
        #  only select N% of the trainig dataset
        # 0.33, 0.66
        logging.info(f"Selecting {args.select_train_data_ratio} of the training data")
        max_batches = int(len(train_loader) * args.select_train_data_ratio)
