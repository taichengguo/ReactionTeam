...
def add_train_args(parser):
    ...
    # mol
    group.add_argument("--boosting_interval", help="No. of steps per saving", type=int, default=2)
    # add ratio float
    group.add_argument("--select_train_data_ratio", help="Ratio of experts to be used", type=float, default=1.0)
...
def add_predict_args(parser):
    ...
    # dropout
    group.add_argument("--do_dropout", help="Whether to dropout", action="store_true")

    # ablation studies
    group.add_argument("--num_experts", help="Ablation study", type=int, default=0)
    group.add_argument("--num_dropout", help="Ablation study", type=int, default=0)

    # add exp_no ,default is 1
    group.add_argument("--exp_no", help="Experiment number", type=int, default=1)
